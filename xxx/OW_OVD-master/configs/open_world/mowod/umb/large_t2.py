...
prev_intro_cls = 20
cur_intro_cls = 20
train_json = 'MOWOD/umb_t2_train.json'
setting_path = 'data/VOC2007/MOWOD/t2_setting.pth'
# umb setting
class_distribution_cfg = dict(
    balance=0.1,
    alpha=0.9,
    save_root='UMB/MOWOD/t2_class_distribution',
...
load_from = 'fomo_mowod/t2/final.pth'
