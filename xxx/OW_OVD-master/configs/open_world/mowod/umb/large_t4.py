...
prev_intro_cls = 60
cur_intro_cls = 20
train_json = 'MOWOD/umb_t4_train.json'
setting_path = 'data/VOC2007/MOWOD/t4_setting.pth'
# umb setting
class_distribution_cfg = dict(
    balance=0.1,
    alpha=0.1,
    save_root='UMB/MOWOD/t4_class_distribution',
...
load_from = 'fomo_mowod/t4/final.pth'
