...
prev_intro_cls = 60
cur_intro_cls = 20
train_json = 'SOWOD/t4_train.json'
# embedding_path = 'data/VOC2007/SOWOD/t4_gt_embeddings.npy'
# att_embeddings = 'data/VOC2007/SOWOD/task_att_1_2_3_4_embeddings.pth'
embedding_path = 'data/VOC2007/SOWOD/t4_gt_embeddings.npy'
att_embeddings = 'data/VOC2007/SOWOD/task_att_1_2_3_4_embeddings.pth'
top_k = 1
pipline = [dict(type='att_select', log_start_epoch=5)]
thr = 0.75
alpha = 0.3
use_sigmoid=True
distributions = '/home/xx/yolo_world_next/YOLO-World/paper_result/previous_log/sowod_distribution_sim4.pth'
