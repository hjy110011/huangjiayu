...
# ================= 15-15-15-15 划分配置 =================
SOWOD_TASKS = [
    ("t1_train", [11, 12, 13, 15, 17, 18, 19, 20, 23, 33, 38, 40, 41, 47]),
    ("t2_train", [21, 24, 25, 26, 27, 28, 29, 32, 34, 35, 36, 37, 49, 50, 51, 52, 45]),
    ("t3_train", [53, 54, 55, 56, 57, 59, 60, 61, 62, 63, 64, 65, 66, 44]),
    ("t4_train", [71, 72, 73, 74, 76, 77, 79, 83, 84, 86, 89, 91, 93, 94, 42])
]
