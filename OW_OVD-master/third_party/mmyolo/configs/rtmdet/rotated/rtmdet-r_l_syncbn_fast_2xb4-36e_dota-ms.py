...
# Path of our images folder
test_data_prefix = 'our/images/'
...
# Inference on our dataset and format the output results
# for submission. Note: the our set has no annotation.
# test_dataloader = dict(
#     dataset=dict(
#         data_root=data_root,
#         ann_file='', # our set has no annotation
