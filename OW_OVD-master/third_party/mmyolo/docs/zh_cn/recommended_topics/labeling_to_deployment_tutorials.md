...
└── $DATA_ROOT
    ├── annotations
    │    ├── trainval.json # 根据上面的指令只划分 trainval + our，如果您使用 3 组划分比例的话，这里是 train.json、val.json、our.json
    │    └── our.json
    ├── images
    │    ├── image1.jpg
    │    ├── image1.png
...
python ./tools/deploy.py \
    ...
    --our-img ${MMYOLO_PATH}/data/cat/images/mmexport1633684751291.jpg \
