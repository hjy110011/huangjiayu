...
# hyper-parameters
class_names = [
    # --- Task 1: Land Transport (18 classes) ---
    ...
    # --- Task 2: Maritime & Air (14 classes) ---
...
train_json = 'SOWOD_Split/t3_train.json'
test_json='SOWOD_Split/test.json'
...
# att_embeddings = None
embedding_path = '/home/gdut-627/106G/public-dataset/OWOD/xview/xView_VOC/SOWOD_Split/t3_gt_embeddings.npy'
att_embeddings = '/home/gdut-627/106G/public-dataset/OWOD/xview/xView_VOC/SOWOD_Split/task_att_1_2_3_embeddings.pth'
top_k = 2
