...
train_json = 'SOWOD_Split/t1_train.json'
...
# att_embeddings = None
embedding_path = '/home/gdut-627/106G/public-dataset/OWOD/xview/xView_VOC/SOWOD_Split/t1_gt_embeddings.npy'
att_embeddings = '/home/gdut-627/106G/public-dataset/OWOD/xview/xView_VOC/SOWOD_Split/task_att_1_embeddings.pth'
top_k = 2
pipline = [dict(type='att_select', log_start_epoch=1)]
thr = 0.6
alpha = 0.3
use_sigmoid=True
distributions = 'paper_repeat/sowod2-1/previous_log/sowod_distribution_sim1.pth'
