...
prev_intro_cls = 0
cur_intro_cls = 10
data_root = '/kaggle/input/datasets/hjy111000/uav-sowod/SOWOD_Merged_VOC'
...
# att_embeddings = None
embedding_path = '/kaggle/input/datasets/hjy111000/uav-sowod/SOWOD_Merged_VOC/SOWOD_Split/t1_gt_embeddings.npy'
att_embeddings = '/kaggle/input/datasets/hjy111000/uav-sowod/SOWOD_Merged_VOC/SOWOD_Split/task_att_1_embeddings.pth'
class_text_path=f'/kaggle/input/datasets/hjy111000/uav-sowod/SOWOD_Merged_VOC/SOWOD_Split/texts/class_texts.json'
file_name='test.txt'
...
top_k =10
use_sigmoid=True
distributions = 'paper_repeat/sowodq11/previous_log/sowod_distribution_sim1.pth'
