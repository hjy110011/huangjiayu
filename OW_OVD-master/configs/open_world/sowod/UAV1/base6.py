...
# att_embeddings = None
embedding_path = '/home/gdut-627/106G/public-dataset/OWOD/UAV-OWD/SOWOD_Merged_VOC/SOWOD_Split/t1_gt_embeddings.npy'
att_embeddings = '/home/gdut-627/106G/public-dataset/OWOD/UAV-OWD/SOWOD_Merged_VOC/SOWOD_Split/task_att_1_embeddings.pth'
...
top_k = 10
use_sigmoid = True
distributions = 'paper_repeat/sowodq1221/previous_log/sowod_distribution_sim1.pth'
...
model = dict(type='UAVDetector',
             ...
             neck=dict(type='UAVAPAFPN',
                       freeze_all=False,
                       guide_channels=text_channels,
                       embed_channels=neck_embed_channels,
                       num_heads=neck_num_heads,
                       block_cfg=dict(type='MaxSigmoidCSPLayerWithTwoConv')),
             bbox_head=dict(type='UavDHead',
