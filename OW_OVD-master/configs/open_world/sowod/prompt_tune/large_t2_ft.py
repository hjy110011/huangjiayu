...
# open world setting
prev_intro_cls = 20  # enable all known train
cur_intro_cls = 20  # enable all known train
train_json = 'MOWOD/t2_ft.json'
setting_path = 'data/VOC2007/MOWOD/t2_ft_setting.pth'
# yolo world setting
num_classes = 80
...
load_from = '/home/xx/yolo_world_next/YOLO-World/results/fomo/t2/finetune.pth'
...
test_evaluator = dict(_delete_=True,
                     ...
                     cfg=dict(
                        ...
                        unknown_id=80,
                        class_names='data/texts/MOWOD/class_texts.json'
                     )
                    )
