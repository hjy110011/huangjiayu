...
prev_intro_cls = 40
cur_intro_cls = 20
train_json = 'SOWOD/umb_t3_train.json'
setting_path = 'data/VOC2007/SOWOD/t3_setting.pth'
# umb setting
class_distribution_cfg = dict(
    balance=0.1,
    alpha=0.1,
    save_root='UMB/SOWOD/t3_class_distribution',
...
load_from = 'fomo_sowod/t3/final.pth'
