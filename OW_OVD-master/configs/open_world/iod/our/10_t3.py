...
# --- 适配 OWOD T1 阶段：训练 5 个类别 ---
num_training_classes = cur_intro_cls # 5
num_classes = num_total_classes  # 测试时检测所有 10 个类别

# VisDrone11 标注文件路径
train_json = 'annotations/train_coco.json'
val_json = 'annotations/val_coco.json'
test_json = 'annotations/test_coco.json'

# Image 路径前缀
train_img_prefix = 'VisDrone2019-DET-train/images/'
val_test_img_prefix = 'VisDrone2019-DET-val/images/'
