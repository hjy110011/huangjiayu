...
coco_train_dataset = dict(
        ...
        class_text_path=f'/home/gdut-627/huangjiayu/visdrone_class_texts.json', # 需确认文本路径
...
optim_wrapper = dict(optimizer=dict(_delete_=True, type='AdamW', lr=base_lr, weight_decay=weight_decay, batch_size_per_gpu=train_batch_size_per_gpu),
