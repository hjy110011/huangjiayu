...
# embedding_path = '/home/gdut-627/huangjiayu/t2_gt_embeddings.npy'
# att_embeddings = '/home/gdut-627/huangjiayu/datasets/universal_att_embeddings_500.pth'
embedding_path = '/home/gdut-627/huangjiayu/t2_gt_embeddings.npy'
# Attribute Embeddings
att_embeddings = '/home/gdut-627/huangjiayu/task_att_embeddings_t2.pth'
train_json = '/home/gdut-627/huangjiayu/datasets/VisDrone/annotations/train/task2.json'
test_json = '/home/gdut-627/huangjiayu/datasets/VisDrone/annotations/val/task2.json'
save_epoch_intervals = 1
thr = 0.5
alpha = 0.2
use_sigmoid=True
# 增量设置
prev_intro_cls = 4  # 之前已有4类
cur_intro_cls = 3  # 新增3类
num_training_classes = 7  # 总共训练7类
num_classes = 7  # 验证时也是7类
pipline = [dict(type='att_select', log_start_epoch=1)]
# 分布传递
distributions = 'work_dirs/visdrone_t2/distribution_sim2.pth'
# 重要：指向 T1 训练生成的分布文件
previous_distribution = 'work_dirs/visdrone_t1/distribution_sim1.pth'
top_k = 10
# yolo world setting
...
load_from = '/home/gdut-627/huangjiayu/work_dirs/task1/best_Current class AP50_epoch_40.pth'
...
test_dataloader = dict(dataset=dict(type='YOLOv5CocoDataset',
                        data_root='/home/gdut-627/huangjiayu/datasets/VisDrone',
                        ann_file='annotations/val/task2.json',
                        data_prefix=dict(img='VisDrone2019-DET-val/images/'),
                        filter_cfg=dict(filter_empty_gt=False, min_size=32),
                        pipeline=test_pipeline))
test_evaluator = dict(_delete_=True, type='OWODEvaluator',
                     cfg=dict(dataset_root='/home/gdut-627/huangjiayu/datasets/VisDrone/VisDrone_VOC_tasks/task2', file_name='test.txt',
