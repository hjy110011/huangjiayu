...
prev_intro_cls = 60
cur_intro_cls = 20
train_json = 'MOWOD/t4_train.json'
# embedding_path = 'data/VOC2007/MOWOD/t4_gt_embeddings.npy'
# att_embeddings = 'data/VOC2007/MOWOD/task_att_1_2_3_4_embeddings.pth'
embedding_path = 'data/VOC2007/MOWOD/t4_gt_embeddings.npy'
att_embeddings = 'data/VOC2007/MOWOD/task_att_1_2_3_4_embeddings.pth'
...
alpha = 0.2
use_sigmoid=True
distributions = 'paper_repeat/mowod/previous_log/mowod_distribution_sim4.pth'
previous_distribution = 'paper_repeat/mowod/previous_log/mowod_distribution_sim3.pth'
top_k = 2
# yolo world setting
