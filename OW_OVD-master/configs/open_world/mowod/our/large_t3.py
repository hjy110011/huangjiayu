...
# embedding_path = 'data/VOC2007/MOWOD/t3_gt_embeddings.npy'
# att_embeddings = 'data/VOC2007/MOWOD/task_att_1_2_3_embeddings.pth'
# embedding_path = 'data/VOC2007/MOWOD/fomo_image_net_t3.npy'
# att_embeddings = None
embedding_path = 'data/VOC2007/MOWOD/t3_gt_embeddings.npy'
att_embeddings = 'data/VOC2007/MOWOD/task_att_1_2_3_embeddings.pth'
...
alpha = 0.2
use_sigmoid=True
distributions = 'paper_repeat/mowod/previous_log/mowod_distribution_sim3.pth'
previous_distribution = 'paper_repeat/mowod/previous_log/mowod_distribution_sim2.pth'
top_k = 2
# yolo world setting
