...
embedding_path = 'data/VOC2007/MOWOD/t1_gt_embeddings.npy'
# att_embeddings = 'data/VOC2007/MOWOD/att_t_1_embeddings.pth'
att_embeddings = 'data/VOC2007/MOWOD/task_att_1_embeddings.pth'
# embedding_path = 'data/VOC2007/MOWOD/fomo_image_net_t1.pth'
pipline = [dict(type='att_select', log_start_epoch=1)]
thr = 0.55
alpha = 0.2
use_sigmoid=True
distributions = 'paper_repeat/mowod/previous_log/mowod_distribution_sim1.pth'
# distributions = 'paper_result/previous_log/mowod_distribution_sim1.pth'
top_k = 20
# yolo world setting
num_classes = 20
