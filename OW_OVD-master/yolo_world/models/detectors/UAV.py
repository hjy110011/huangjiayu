...
from mmengine.logging import MessageHub  # [新增 1] 导入 MessageHub

@MODELS.register_module()
class UAVDetector(YOLODetector):
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        # [新增 2] 获取当前 epoch 和 max_epochs
        message_hub = MessageHub.get_current_instance()
        epoch_info = {}
        if message_hub is not None:
            epoch_info['current_epoch'] = message_hub.get_info('epoch')
            epoch_info['max_epochs'] = message_hub.get_info('max_epochs')
