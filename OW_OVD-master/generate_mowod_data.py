...
# ================= 配置区域 =================
# 输出根目录 (根据您的配置文件路径调整)
OUTPUT_ROOT = "data/VOC2007/MOWOD"
TEXT_OUTPUT_DIR = "data/texts/MOWOD"
...
# 属性源文件 (上一步生成的 json)
ATTRIBUTES_FILE = "/home/gdut-627/huangjiayu/OW_OVD-master/attributes_mowod.json"

# ================= 类别定义 (M-OWODB Task Splits) =================
