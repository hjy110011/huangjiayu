...
def parse_args():
    parser = argparse.ArgumentParser(
        description='MMYOLO our (and eval) a model')
    parser.add_argument('config', help='our config file path')
    ...
    parser.add_argument(
        ...
        'format and submit it to the our server')
    parser.add_argument(
        '--tta',
        action='store_true',
        help='Whether to use our time augmentation')
    parser.add_argument(
